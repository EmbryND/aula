...
<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
        ...
        <img src="{{url('imagens/armariogames.jpg')}}"  <span class="fs-4">ArMarioGames</span>
      </a>
    ...
    <br>
    <main>
        <h2 class="secao_playstation"><img class="icone_secao" src="{{url('imagens/playstation.png')}}"></h2>
    ...
    <br>
    <h2 class="secao_xbox"><img class="icone_secao" src="{{url('imagens/xbox.png')}}"></h2>
    ...
    <br>
    <h2 class="secao_nintendo"><img class="icone_secao" src="{{url('imagens/nintendo.png')}}"></h2>
